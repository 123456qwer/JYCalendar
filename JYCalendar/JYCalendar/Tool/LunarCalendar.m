...
-(NSString *)getWorldHoliday:(int)aMonth day:(int)aDay
{
    ...
    [dict setObject:@"知识产权日 复活节" forKey:@"0426"];
...
-(NSString *)getWeekHoliday:(int)aYear month:(int)aMonth day:(int)aDay
{
    ...
    [dict setObject:@"国际母亲节" forKey:@"0520"];
    ...
    [dict setObject:@"世界儿童日" forKey:@"0940"];
    [dict setObject:@"世界海事日" forKey:@"0950"];
    [dict setObject:@"国际住房日" forKey:@"1011"];
